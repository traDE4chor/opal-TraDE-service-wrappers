...
ADD opalmcimdarg ${OPAL_EXEC}
ADD prepareOpalInFile.sh ${OPAL_EXEC}
WORKDIR ${OPAL_EXEC}
RUN chmod -R a+x *

EXPOSE 8080

COPY --from=builder /opt/opal/target/opalMC.war ${CATALINA_HOME}/webapps
...
#
#   docker build -t trade4chor/opalmc-service-wrapper .
#
# 
